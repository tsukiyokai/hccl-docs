# SetCLayout-Matmul Tiling类-Matmul Tiling侧接口-矩阵计算-高阶API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 1 | int32_tSetCLayout(int32_tb,int32_ts,int32_tn,int32_tg,int32_td) |
| --- | --- |
