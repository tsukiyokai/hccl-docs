# WaitPreTaskEnd-任务间同步-同步控制-基础API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
![](../images/atlasascendc_api_07_00088_img_002.png)

#### 函数原型

| 1 | __aicore__inlinevoidWaitPreTaskEnd() |
| --- | --- |
