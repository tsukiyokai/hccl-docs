# printf-AI CPU API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
**页面ID:** atlasascendc_api_07_00165
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/ascendcopapi/atlasascendc_api_07_00165.html
---
...
| 12345678910111213 | #include"aicpu_api.h"// 整型打印：AscendC::printf("fmt string %d\n",0x123);// 浮点型打印：floata=3.14;AscendC::printf("fmt string %f\n",a);// 指针打印：intb=10;int*c=&b;AscendC::printf("TEST %p\n",c); |
| --- | --- |

程序运行时打印效果如下：

| 123 | fmtstring291fmtstring3.140000TEST0xdfffd6fddd1c |
| --- | --- |
