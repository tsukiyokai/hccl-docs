# GetTensorC-Conv3DBackpropFilter Kernel侧接口-Conv3DBackpropFilter-卷积计算-高阶API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 12 | template<boolsync=true>__aicore__inlinevoidGetTensorC(constAscendC::GlobalTensor<DstT>&output,uint8_tenAtomic=1,boolenSequentialWrite=false) |
| --- | --- |
...
| 123 | while(gradWeight_.Iterate()){gradWeight_.GetTensorC(gradWeightGm_[offsetC_]);} |
| --- | --- |
