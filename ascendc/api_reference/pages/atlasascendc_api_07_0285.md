# SetAtomicMin(ISASI)-原子操作-基础API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 12 | template<typenameT>__aicore__inlinevoidSetAtomicMin() |
| --- | --- |
