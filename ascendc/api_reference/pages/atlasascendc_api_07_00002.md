# PrintTimeStamp-上板打印-调试接口-基础API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 1 | descIdis65577,rsvis0,timeStampis13806084506158,pcPtris20619064414544,entryis0. |
| --- | --- |
...
| 1 | __aicore__inlinevoidPrintTimeStamp(uint32_tdescId) |
| --- | --- |
...
| 123 | opType=AddCustom,DumpHead:AIV-0,CoreType=AIV,blockdim=8,total_block_num=8,block_remain_len=1047136,block_initial_space=1048576,rsv=0,magic=5aa5bccd...// 一些框架内部的打点信息descIdis65577,rsvis0,timeStampis13806084506158,pcPtris20619064414544,entryis0. |
| --- | --- |
