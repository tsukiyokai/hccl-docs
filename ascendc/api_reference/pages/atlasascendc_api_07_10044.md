# SetSkipBufferWindowCopy-HCCL Tiling侧接口-HCCL通信类-高阶API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 1 | uint32_tSetSkipBufferWindowCopy(uint8_tskipBufferWindowCopy) |
| --- | --- |
