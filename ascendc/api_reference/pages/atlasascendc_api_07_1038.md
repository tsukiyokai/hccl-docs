# GetResCubeGroupWorkSpaceSize-PlatformAscendC-平台信息获取-Utils API-Ascend C算子开发接口-API-CANN社区版8.5.0开发文档-昇腾社区
...
| 1 | uint32_tGetResCubeGroupWorkSpaceSize(void)const |
| --- | --- |
