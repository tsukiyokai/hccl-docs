...
3. Interactive and Aligned IDEs in the LLM Era — LLM时代的交互式IDE
4. Utilizing Runtime Information to Improve Development Processes — 利用运行时信息改进开发流程
5. Intelligent Teaching Assistant in Programming Education — 编程教育智能助教
...
- Burcu Kulahcioglu Ozkan (Track 4 Lead)
...
- Agnia Sergeyuk (Track 3 Lead / PhD)
- Anastasiia Birillo (Track 5 Lead)
...
- Roham Koohestani (Track 3, Research Assistant)
- Zahra Seyedghorban (Track 4, 2024.12-)
- Yuri Noviello (Track 5, 2024.10-)
